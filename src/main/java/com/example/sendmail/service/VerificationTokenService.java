...
import com.example.sendmail.model.VerificationToken;
import com.example.sendmail.repository.UserRepository;
import com.example.sendmail.repository.VerificationTokenRepository;
...
public class VerificationTokenService {
    ...
    public ResponseEntity<String> verifyEmail(String token){
        ...
        verificationTokenRepository.save(verificationToken);
        return ResponseEntity.ok("You have successfully verified yur email address.");
    }
}
